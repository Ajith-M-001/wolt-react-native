  ...
  return (
    <View style={styles.container}>
      <View style={styles.infiniteScrollContainer}>
        <View>
          <SmoothInfiniteScroll iconSet="set1" scrollDirection="up" />
        </View>
        <View>
          <SmoothInfiniteScroll iconSet="set2" scrollDirection="down" />
        </View>
        <View>
          <SmoothInfiniteScroll iconSet="set3" scrollDirection="up" />
        </View>
        <LinearGradient
